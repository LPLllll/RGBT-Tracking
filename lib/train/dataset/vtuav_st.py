...
class VTUAVST(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        super().__init__('VTUAVST', root, image_loader)
    ...
    def _get_frame_path(self, seq_path, frame_id):
        vis_frame_names = sorted(os.listdir(os.path.join(seq_path, 'ir')))
        inf_frame_names = sorted(os.listdir(os.path.join(seq_path, 'rgb')))

        return os.path.join(seq_path, 'ir', vis_frame_names[frame_id]), os.path.join(seq_path, 'rgb', inf_frame_names[frame_id])
