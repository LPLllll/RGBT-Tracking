...
from lib.models.tracker.vit_mplt_care import vit_base_patch16_224_mplt
...
def build_mplt_track(cfg, training=True):
    ...
    if cfg.MODEL.PRETRAIN_FILE and ('MPLTTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
